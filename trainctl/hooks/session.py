...
from trainctl.hooks.runner import ExecutionResult
...
class HookSession:
    ...
    def handle(
        ...
        *,
        ...
        """Dispatches one callback occurrence's light hook, if this rank is eligible.
        ...
        Args:
            ...
            arguments: This callback's own named arguments, for the bounded
                metadata description. Defaults to an empty mapping.

        Returns:
            `None` if this rank is ineligible under the configured rank policy, or
            the light script is not currently enabled. Otherwise the light
            invocation's `ExecutionResult`.
        """
